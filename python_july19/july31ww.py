...
input_file_path = r'C:\Users\sunil\OneDrive\Desktop\Db2 Challenges\organise\Beuatiful\placement_19july\project1_a\input_text.txt'
...
for poly in mesh.polygons:
    ...
    if is_z_direction(normal):
        poly.material_index = 0  # Material_Z
    else:
        poly.material_index = 1  # Material_Other
...
# Set the resolution
bpy.context.scene.render.resolution_x = 584
