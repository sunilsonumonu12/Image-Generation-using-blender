...
image_path = r"C:\Users\sunil\OneDrive\Desktop\Db2 Challenges\organise\Beuatiful\placement_19july\python_july19\simple9.jpg"
...
def project_and_stretch_uv(obj_name, scale_factor):
    ...
    # Apply UV projection (Smart UV Project or Cube Projection)
    bpy.ops.uv.smart_project(angle_limit=66, island_margin=0.02)

    # Verify the UV layer
    uv_layer = bm.loops.layers.uv.verify()

    # Scale the UVs of the selected faces
    for f in bm.faces:
        for loop in f.loops:
    ...
    # Free the BMesh (optional, happens automatically when exiting Edit Mode)
    bm.free()
...
project_and_stretch_uv(obj_name="Plane", scale_factor=1.0)
if plane is None:
    ...
    mapping_node = nodes.new(type='ShaderNodeMapping')
    tex_coord_node = nodes.new(type='ShaderNodeTexCoord')
    image_path = r"C:\Users\sunil\OneDrive\Desktop\Db2 Challenges\organise\Beuatiful\placement_19july\python_july19\simple11.jpg"
...
#C:\Users\sunil\OneDrive\Desktop\Db2 Challenges\organise\Beuatiful\placement_19july\project1_a\input_text.txt
...
font_path = r"C:\Users\sunil\Downloads\autumn-lover-font\AutumnLover-OGZve.ttf"
...
# Create a new material for the sphere
material = bpy.data.materials.new(name="TranslucentYellowMaterial")
material.use_nodes = True
...
# Set translucent node properties for a yellow color
translucent_node.inputs['Color'].default_value = (1.0, 0.9333, 0.0, 1.0)  # Translucent yellow color

# Mix shader settings to control translucency
mix_shader_node.inputs['Fac'].default_value = 0.9  # Adjust this value to change the transparency
...
sphere = bpy.context.active_object  # Make sure the sphere is the active object
...
light1_color = (1.0, 0.9333, 0.0) # FF00FC in RGB
light1_energy = 150.0
...
light2_color = (0.0, 1.0, 0.1333)  # 2393FF in RGB
light2_energy = 150.0
...
# Set the newly created camera as the active camera for rendering
bpy.context.scene.camera = camera
